...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className="group peer fixed left-0 top-[65px] bottom-0 text-sidebar-foreground w-[80px]"
        data-state={state}
      ...
      >
        <div
          data-sidebar="sidebar"
          className="h-full w-full flex flex-col bg-sidebar border-r border-sidebar-border"
        >
          {children}
        </div>
      </div>
